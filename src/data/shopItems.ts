...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  },
  {
    ...
    description: 'Reworked in patch 7.41 to also grant HP, mana, and cast range. Releases a burst of magical energy for instant damage. Upgradable 5 times. No longer provides spell lifesteal.',
    stats: ['+6 All Stats', '+200 HP', '+350 Mana', '+60 Cast Range'],
    active: 'Energy Burst: Deals 400 magical damage to target (level 5: 800 damage). Cast range bonus does not stack with Aether Lens.',
    tier: 'Upgrade',
