...
const INTERNAL = [
  ...
  { label: 'In-Game Shop',  href: '/shop' },
  { label: 'Neutral Items', href: '/neutral' },
];

const EXTERNAL = [
  { label: 'Dota 2 Official', href: 'https://www.dota2.com' },
  { label: 'Dota 2 Wiki',     href: 'https://dota2.fandom.com/wiki/Dota_2_Wiki' },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-white/5">
          <p className="text-xs text-gray-700 leading-relaxed max-w-2xl">
            Dota 2 is a trademark of Valve Corporation. All hero names, images, and
            descriptions are property of Valve Corporation. This site is not affiliated
            with or endorsed by Valve. Images sourced from Valve's official CDN.
          </p>
        </div>
      </div>
    </footer>
